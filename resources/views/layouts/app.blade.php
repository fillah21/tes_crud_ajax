    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-lg-center">
          @auth
          <li class="nav-item"><span class="btn-outline-dark name me-4 fw-bold">Halo, {{ Auth::user()->name }}</span></li>
          ...
          <li class="nav-item"><a class="btn btn-outline-dark me-2" href="{{ route('profile.edit') }}">Profile</a></li>
